    ...
    <header class="flex items-center w-full bg-white justify-between py-10">
      <a class="break-words" aria-label="Tragos locos blog" href="/">
        <div class="flex items-center justify-between">
          <div class="mr-3">
            <img src="/favicon.png" class="w-8 h-8" alt="Tragos locos blog logo" />
          </div>
          <div class="hidden h-6 text-2xl font-semibold sm:block">Tragos Locos Blog</div>
        </div>
      </a>
      <div class="flex items-center space-x-4 leading-5 sm:-mr-6 sm:space-x-6">
        <div class="no-scrollbar hidden max-w-40 items-center gap-x-4 overflow-x-auto sm:flex md:max-w-72 lg:max-w-96">
          ...
          <a class="hover:text-primary-500 m-1 font-medium text-gray-900" href="/">App</a>
        </div>
        <button aria-label="Toggle Menu" class="sm:hidden">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="hover:text-primary-500 h-8 w-8 text-gray-900">
